...
for (ctn in 1:length(cts_to_analyze)) {
  ...
  # New - expression in at least 5 samples
  ...
  #        "/scratch/aoill/projects/heart_transplant/GLMM_results_CAV_AMR_pre_treatment_all_rm_model_errors_fix_exp_20241126_in_progress_results.rds")
...
#        "/scratch/aoill/projects/heart_transplant/GLMM_results_CAV_AMR_pre_treatment_all_rm_model_errors_fix_exp_20241126_FIX.rds")
...
# Save
# THIS IS SUPPLEMENTARY TABLE 10
write.csv(cr_pre_cav_grade_all_CT_results_filter_merged, "/home/aoill/projects/heart_transplant/00_final/GLMM_CAV_grade_AMR_pre_treatment_biopsies_NEW.csv",
          row.names = F, quote = F)